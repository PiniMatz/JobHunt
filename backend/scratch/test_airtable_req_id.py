...
def test():
    ...
    # Generate a random requestId or use the pageLoadId
    req_id = "req" + str(uuid.uuid4()).replace("-", "")[:15]
    ...
    url_api = f"https://airtable.com/v0.3/view/{view_id}/readSharedViewData?stringifiedObjectParams=%7B%22shouldUseNestedResponseFormat%22%3Atrue%7D&requestId={req_id}"
